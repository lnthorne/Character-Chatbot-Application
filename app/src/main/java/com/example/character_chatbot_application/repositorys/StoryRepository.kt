...
//            Hash passwd here
    ...
    suspend fun updateCharacterNameAndDescription(id: Int, newName: String, newDescription: String) {
        characterDao.updateCharacterNameAndDescription(id, newName, newDescription)
    }
